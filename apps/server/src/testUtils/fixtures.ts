...
async function loadAuthors() {
  await createAuthor({
    ...
    photoPath: "/authors/JK%20Rowling.jpg"
  });
  ...
  await createAuthor({
    ...
    photoPath: "/authors/James%20S.%20A.%20Corey.jpg"
  });
